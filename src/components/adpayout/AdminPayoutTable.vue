...
const { executeApi: fetchPayoutsAdmin, isLoading } = getPayoutsAdmin()
// const { executeApi: fetchPayoutsPartner, isLoading:isPayoutPartnerLoading } = getPayoutsPartner()
...
function createColumns({
  ...
  resolveRequest: (payoutId: string) => void
...
// ========== HANDLE RESOLVE PAYOUT REQUEST ========

const { resolvePayout } = usePayout()

// destruct useClipboard
const { copy } = useClipboard()
// create columns
const columns = createColumns({
  resolveRequest(payoutId) {
